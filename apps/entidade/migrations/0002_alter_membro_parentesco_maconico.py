...
from apps.entidade.models import Entidade, Membro
from apps.tesouraria.models import Tipo_arrecadacao,Tipo_conta
...
def criar_tipo_arrecadacao(apps, schema_editor):
