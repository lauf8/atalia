...
from .views.views_list import (list_everthing, list_patrimonio, list_patrimonio_especifc, 
                               list_entidade_especific, list_members, list_members_especific,show_members,
                               show_members)
...
urlpatterns = [
    ...
    path('membros/<int:pk>/show',show_members, name='show_members'),
    ...
    path('patrimonio/<int:pk>/show',show_members, name='show_members'),
